...
public class EndingManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        // 각 스테이지의 시간을 UI에 표시
        stage1TimeText.text = "Stage 1 Time: " + stage1Time.ToString("F1") + "s";
        stage2TimeText.text = "Stage 2 Time: " + stage2Time.ToString("F1") + "s";
        stage3TimeText.text = "Stage 3 Time: " + stage3Time.ToString("F1") + "s";
    }
}
